...
.addField("Gram Altın", `
  ...
  exports.conf = {
    aliases: ["döviz"], //Komutun farklı yazılışlarla kullanımları
  ...
  exports.help = {
    name: 'döviz',  //adını belirtin (kullanmak için gereken komut) Örneğin Otorol
    description: 'Dövizi Gösterir.', //Komutun açıklaması
    usage: 'döviz', //Komutun kullanım şekli (örneğin !otorol <@rol> <#kanal>)
  };