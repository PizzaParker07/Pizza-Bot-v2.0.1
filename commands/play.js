...
exports.run = async (client, message, args) => {
  ...
  exports.conf = {
    aliases: ['oynat', 'p'], //Komutun farklı yazılışlarla kullanımları
  ...
  exports.help = {
    name: 'play',  //adını belirtin (kullanmak için gereken komut) Örneğin Otorol
    description: 'play', //Komutun açıklaması
    usage: 'play', //Komutun kullanım şekli (örneğin !otorol <@rol> <#kanal>)
  };